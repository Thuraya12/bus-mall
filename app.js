...
let threevar = []
function ifRepeat() {
  console.log('ifRepeat output ', threevar, firstImageIndex, secondImageIndex, thirdImageIndex);
  for (let i = 0; i < threevar.length; i++) {
    if (threevar[i] === firstImageIndex || threevar[i] === secondImageIndex || threevar[i] === thirdImageIndex) {
  ...
  threevar = [firstImageIndex, secondImageIndex, thirdImageIndex]
  return false
}
...
function displayThreeImages() {
  ...
  } while (firstImageIndex === secondImageIndex || firstImageIndex === thirdImageIndex || secondImageIndex === thirdImageIndex || ifRepeat())
